...
| <a name="input_container_jobs"></a> [container\_jobs](#input\_container\_jobs) | List of container jobs to be created | <pre>map(object({<br/>    image_name = string<br/>    image_tag  = string<br/>    script     = string<br/>  }))</pre> | `{}` | no |
